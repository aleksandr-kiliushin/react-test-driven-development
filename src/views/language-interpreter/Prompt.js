...
const mapStateToProps = ({ script: { nextInstructionId }, environment: { promptFocusRequest } }) => ({
  nextInstructionId,
  promptFocusRequest,
})
...
export const Prompt = connect(
  mapStateToProps,
  mapDispatchToProps
)(({ nextInstructionId, promptFocusRequest, submitEditLine, promptHasFocused, startAnimating }) => {
