...
import { initialState, parseStatement, parseTokens } from "../src/parser"

describe.skip("parseStatement", () => {
  it("moves forward", () => {
  ...
  describe("no-argument functions", () => {
    ...
    it("accepts the wait command", () => {
      ...
      expect(state.drawCommands).toEqual([{ drawCommand: "wait", seconds: 5 }])
    })
  })
