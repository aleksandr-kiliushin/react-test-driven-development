...
describe.skip("ScriptName", () => {
  let container, renderWithStore, blur, change, focus, keyPress

  beforeEach(() => {
    ;({ container, renderWithStore, blur, change, focus, keyPress } = createContainerWithStore())
  })
  ...
  describe("when the user hits Enter", () => {
    ...
    it("dispatches a prompt focus request", () => {
      return expectRedux(store).toDispatchAnAction().matching({ type: "PROMPT_FOCUS_REQUEST" })
    })
  })
