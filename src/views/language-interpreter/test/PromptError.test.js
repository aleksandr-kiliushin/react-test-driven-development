...
describe.skip("PromptError", () => {
  ...
  it("renders a single td with a colspan of 2", () => {
    ...
    expect(container.querySelector("td").getAttribute("colSpan")).toEqual("2")
  })
  ...
  describe("with error present", () => {
    ...
    it("displays the error from state in a table cell", () => {
      ...
      expect(container.querySelector("td").textContent).toEqual("error message")
    })
  })
})
